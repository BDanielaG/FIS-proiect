...
//    private float discount;
    ...
    public Zbor(int id, int cod_zbor, int nr_locuri_total, LocalDate ora_plecare, LocalDate ora_sosire, String nume_companie, String sursa, String destinatie, int nr_locuri_seniori, int nr_locuri_adulti, int nr_locuri_copii, float pret, int locuri_business, int locuri_economy, int lcouri_first) {
        this.id = id;
